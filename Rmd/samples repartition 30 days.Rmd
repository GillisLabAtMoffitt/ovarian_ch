---
title: "samples repartition - 30 days time limits on postsample"
...
* Chemotherapy:  
  ...
  + Sequential sample must be after 30 days from start date  
...
blood_patients <- ovarian_data %>%
  ...
  mutate(seq_sample_chemo = case_when(
    presample_chemo_within_limits == "Yes" &
      ...
      (treatment_start_dt_regimen_1 + days(30)) &
